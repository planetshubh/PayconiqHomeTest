...
class LoginPage {
    ...
    async submitLoginForm(username, password) {
        await t
        .selectText(this.usernameField)
        .pressKey('delete').typeText(this.usernameField, username, { paste: true });

        await t
        .selectText(this.passwordField)
        .pressKey('delete').typeText(this.passwordField, password, { paste: true });
